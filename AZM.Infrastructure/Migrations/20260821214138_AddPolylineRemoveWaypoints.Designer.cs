...
namespace AZM.Infrastructure.Migrations
{
    ...
    [Migration("20260821214138_AddPolylineRemoveWaypoints")]
    partial class AddPolylineRemoveWaypoints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AZM.Domain.Entities.AchievementDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AZM.Domain.Entities.Follow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AZM.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AZM.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastBirthDateChangeUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AZM.Domain.Entities.UserDailyActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AZM.Domain.Entities.Achievement", b =>
                {
                    b.HasOne("AZM.Domain.Entities.AchievementDefinition", "AchievementDefinition")
                        .WithMany()
