...
{
    public class PublishEventHandler : IRequestHandler<PublishEventCommand, Result<bool>>
    {
        private readonly IEventRepository _eventRepo;

        public PublishEventHandler(IEventRepository eventRepo) => _eventRepo = eventRepo;

        public async Task<Result<bool>> Handle(PublishEventCommand cmd, CancellationToken ct)
        {
